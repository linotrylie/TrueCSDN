<template>
  <div class='article'>
    <div class='tag'>
      ...
      <div class='article-content' v-infinite-scroll="load">
        <div class='article-content-item' v-for='item in count' >
          <div class='article-content-item-image' v-if="src1 === ''">
            <el-image></el-image>
          </div>
          <div class='article-content-item-image' v-else>
            <el-image :src="src"></el-image>
          </div>
          <div class='item-left'>
            <div class='title'>
              <router-link to='/article/detail/1'>AIGC技术周报｜图灵测试不是AGI的智力标准；SegGPT：在上下文中分割一切；ChatGPT能玩好文字游戏吗？</router-link>
            </div>
            <div class='content'>
